...
namespace DYear
{
    public static class SunPosition
    {
        ...
        /*!
         * \brief Calculates solar position and returns a 2d vector corresponding to the Altitude and Azimuth in radians
         *
         * Shamelessly stolen from http://guideving.blogspot.com/2010/08/sun-position-in-c.html
         * 
         ...
         */
        public static Rhino.Geometry.Vector2d CalculateSunPosition(
            DateTime dateTime, double latitude, double longitude)
        {
            ...
            return new Vector2d(altitude, azimuth);
        }
